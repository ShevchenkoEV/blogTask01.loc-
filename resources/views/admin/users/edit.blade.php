...
@section('content')
    <div class="card col-6 mx-4 card-primary card-outline shadow-lg">
        <div class="card-header">
            <h3 class="card-title"> Редактирование пользавателя</h3>
                ...
                <div class="card-body ">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control " id="name"
                               name="name" placeholder="Имя" value="{{ $user->name }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input custom-control-input-danger custom-control-input-outline"
                                   type="checkbox" id="checkbox" name="status" value="1" {{ $user->status == 1 ? 'checked' : ''}}>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <img src="{{ $user->getImage()}}" class="img-thumbnail mt-2" alt="image" width="200px">
                        </div>
                    </div>
